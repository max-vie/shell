...
PRIVATE_INPUTS = {
    ...
    "forgejo_repository": f"{PRIVATE_ROOT}/forgejo-repository.sops.json",
...
def validate_public(repository_root: Path = REPOSITORY_ROOT) -> dict[str, Any]:
    ...
    require(
        ...
        and private_inputs["forgejo_repository"]["path"]
        == PRIVATE_INPUTS["forgejo_repository"]
        and private_inputs["forgejo_repository"]["storage"] == "sops-age"
        and private_inputs["forgejo_repository"]["file_mode"] == "0600"
    ...
    handoff = {
        ...
        "sudo_forgejo_repository_path": str(
            root / PRIVATE_INPUTS["forgejo_repository"]
        ),
